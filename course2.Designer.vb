...
Partial Class course2
    ...
    Private Sub InitializeComponent()
        Dim resources As System.ComponentModel.ComponentResourceManager = New System.ComponentModel.ComponentResourceManager(GetType(course2))
        GroupBox1 = New GroupBox()
        hiddencode = New Label()
        greetings3 = New GroupBox()
        ...
        GroupBox1.Controls.Add(greetings3)
        ...
        GroupBox1.Text = "PENETRATION TESTING"
        ' 
        ' hiddencode
        ' 
        hiddencode.AutoSize = True
        hiddencode.Font = New Font("SimSun", 10F, FontStyle.Regular, GraphicsUnit.Point, CByte(0))
        hiddencode.Location = New Point(638, 18)
        hiddencode.Name = "hiddencode"
        hiddencode.Size = New Size(69, 20)
        hiddencode.TabIndex = 3
        hiddencode.Text = "Label3"
        hiddencode.Visible = False
        ' 
        ' greetings3
        ' 
        greetings3.BackColor = SystemColors.ActiveCaptionText
        greetings3.Controls.Add(LinkLabel3)
        greetings3.Controls.Add(Label2)
        greetings3.Controls.Add(Label1)
        greetings3.Controls.Add(PictureBox3)
        greetings3.Controls.Add(PictureBox5)
        greetings3.ForeColor = SystemColors.ControlLightLight
        greetings3.Location = New Point(331, 51)
        greetings3.Name = "greetings3"
        greetings3.Size = New Size(826, 470)
        greetings3.TabIndex = 7
        greetings3.TabStop = False
        greetings3.Text = "GREETINGS"
        ' 
        ' LinkLabel3
        ' 
        ...
        LinkLabel3.Location = New Point(186, 379)
        ...
        Label1.Name = "Label1"
        Label1.Size = New Size(472, 19)
        Label1.TabIndex = 3
        Label1.Text = "Get certified as Kali University Certified Penetration Testing Specialist"
        ' 
        ' PictureBox3
        ' 
        ...
        PictureBox3.Location = New Point(47, 98)
        PictureBox3.Name = "PictureBox3"
        PictureBox3.Size = New Size(154, 88)
        ...
        PictureBox5.Location = New Point(28, 94)
        PictureBox5.Name = "PictureBox5"
        PictureBox5.Size = New Size(771, 251)
        ...
        GroupBox4.Location = New Point(75, 358)
        ...
        LinkLabel2.Location = New Point(22, 9)
        ...
        greetings3.ResumeLayout(False)
        greetings3.PerformLayout()
    ...
    Friend WithEvents greetings3 As GroupBox
